        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    WasteCollectionRequestId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WasteCollections_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WasteCollections_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WasteCollections_WasteTypes_WasteTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WasteCollections_EmployeeId",
                table: "WasteCollections",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_WasteCollections_UserId",
                table: "WasteCollections",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WasteCollections_WasteTypeId",
                table: "WasteCollections",
                column: "WasteTypeId");
        }
